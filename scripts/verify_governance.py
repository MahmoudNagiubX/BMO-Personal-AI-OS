...
REQUIRED_FILES = (
    ...
    "docs/adr/0021-hey-jarvis-owner-specific-verifier.md",
    "docs/adr/0022-rhasspy-pyopen-wakeword-streaming.md",
    "docs/adr/0023-speech-gated-asr-wake.md",
    "docs/adr/0024-full-duplex-conversation-coordinator.md",
    ...
    "infrastructure/tuf/rhasspy_wake_model_manifest.json",
    ...
    "docs/phase_reports/evidence/PHASE_10_OWNER_VERIFIER.json",
    "docs/phase_reports/evidence/PHASE_10_RHASSPY_WAKE_CORE.json",
    "docs/phase_reports/evidence/PHASE_10_SPEECH_GATED_WAKE.json",
    "docs/phase_reports/evidence/PHASE_10_FULL_DUPLEX_CONVERSATION.json",
    ...
    "scripts/phase_10/run_hey_jarvis_reference_probe.py",
    "scripts/phase_10/run_hey_jarvis_reference_probe.ps1",
    "scripts/phase_10/benchmark_rhasspy_hey_jarvis.py",
    "scripts/phase_10/benchmark_speech_gated_wake.py",
    "scripts/phase_10/verify_hey_jarvis_parity.py",
