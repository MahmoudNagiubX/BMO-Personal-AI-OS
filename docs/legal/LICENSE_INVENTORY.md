...
| websockets | `15.0.1` | BSD-3-Clause | Minimal authenticated Phase 7 WebSocket text client | No | PyPI package resolved in `uv.lock`; no external telemetry | Phase 7 repository dependency |
