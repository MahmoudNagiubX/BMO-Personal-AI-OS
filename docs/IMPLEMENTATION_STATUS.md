 ...
 **Current branch target:** `phase-10/jarvis-voice-core`; the current incumbent is the official openWakeWord Hey Jarvis candidate plus bounded local faster-whisper exact-prefix verifier, but the backend reselection gate is blocked. The fresh comparison commit `a9ec14cf014c1413ed17f2aa641723ec75a5dd80` recorded microWakeWord v2 at 217/504 recall and 262/7,268 false activations, and the openWakeWord cascade at 489/504 recall and 75/7,268 false activations, with one false wake in a five-hour stream. Neither meets the locked 98% / 0.25% / 0.1 FAPH gate; no owner physical session is authorized. Right-Ctrl/PTT activation, pre-roll, Smart Turn, barge-in, privacy, and Core authority remain unchanged.
 ...
 **Hey Jarvis final audit:** ADR-0018 records the migration, ADR-0019 is retained as historical cleanup evidence, and ADR-0020 records the fresh two-candidate reselection, official microWakeWord provenance, separate engine/pretrained-model licensing, and blocked software-gate boundary. Phase 11 remains `NOT_STARTED`.
