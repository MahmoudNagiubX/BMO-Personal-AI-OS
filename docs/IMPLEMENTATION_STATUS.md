...
- **Current branch target:** `phase-10/jarvis-voice-core`; Phase 10 is ready for governance-corrected implementation and independent review.
...
- **Later phases authorized:** ADR-0008 historically recorded Phase 5B as `AUTHORIZED_TO_START`. Phase 6, Phase 7, Phase 8, optional Phase 8.5, and Phase 9 are merged in repository history. Phase 10 JARVIS Voice Core is owner-authorized. Phase 11 room/multi-device voice is `NOT_STARTED` and is not authorized by this phase.
