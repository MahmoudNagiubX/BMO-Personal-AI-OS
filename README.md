...
- Local JARVIS voice on the ASUS TUF using an exact bare-`Jarvis` BMO-owned personalized MFCC/DTW adapter with derived-template-only enrollment, double-Right-Ctrl activation, Pipecat Smart Turn, faster-whisper, Silero VAD, and local TTS; room voice remains Phase 11. Rejected neural and grammar candidates remain historical evidence.
