...
- None of the twelve advanced capability families are implemented or authorized by that architecture update.
...
Do not install Ubuntu, modify the Lenovo, deploy BMO, start Phase 5B or Phase 6, create future World State/context services, add proposal-suggested dependencies, change models, or perform a database migration unless a later owner-approved task explicitly authorizes it.
